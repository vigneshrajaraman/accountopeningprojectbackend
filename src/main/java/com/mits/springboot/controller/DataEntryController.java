	...
	public void intialize() {
		...
		auth=new Authority("", "ROLE_dataverifier");	
		 authority = authorityService.insertOrUpdate(auth);
			sets.add(authority);
		Users user= new Users("","vignesh", bCrypt.encode("Vignesh@1234"), "vigneshrajramanusha@gmail.com", new Date(), sets);
		...
		Customer cus= new Customer("1", "Vignesh", "r", "Rajaraman", insertOrUpdate2, Gender.MALE, 21, "dds", "Sdsdds", "ssddsds");
